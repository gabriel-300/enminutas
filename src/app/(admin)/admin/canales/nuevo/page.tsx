...
export default async function NuevoCanalPage() {
  ...
  return (
    <div className="p-8 max-w-lg">
      ...
      <form action={crearCanal} className="bg-white rounded-xl border border-neutral-200 shadow-sm p-6 space-y-5">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-[13px] font-medium text-neutral-800 mb-1.5">Slug * <span className="font-normal text-neutral-600">(único)</span></label>
