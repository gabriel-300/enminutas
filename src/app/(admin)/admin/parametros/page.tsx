...
export default async function ParametrosPage() {
  ...
  return (
    <div className="p-4 md:px-10 md:py-8 md:pb-16 max-w-xl">
      <div className="mb-6">
      ...
      <form action={actualizarParametros} className="space-y-6">
        <div className="bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-neutral-100 bg-neutral-50">
            <p className="text-xs font-semibold text-neutral-600">Fórmula de precio</p>
            ...
            <div className="px-5 py-4 flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <input
                  ...
                  className="w-20 px-3 py-2 text-sm text-right border border-neutral-400 rounded-lg focus:outline-none focus:ring-[3px] focus:ring-brand-500/30 focus:border-brand-700 tabular-nums font-semibold"
                />
        ...
        {/* Resumen live */}
        <div className="bg-crema-50 rounded-xl border border-crema-200 px-5 py-4 text-sm text-neutral-600 space-y-1">
        ...
        <button
          type="submit"
          className="px-6 py-2.5 rounded-lg bg-tierra-700 text-white text-sm font-medium hover:bg-tierra-800 transition-colors"
        >
          Guardar parámetros
        </button>
      </form>
