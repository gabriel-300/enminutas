...
const contactLinks = [
  {
    label: "+54 376 5017944",
    href: `https://wa.me/${WA_NUMBER}`,
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden className="text-neutral-500 shrink-0">
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="text-neutral-500 shrink-0">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
              <span
                className="size-8 rounded-lg text-white flex items-center justify-center font-bold text-sm"
            ...
            <div className="flex flex-wrap gap-2">
              {["FOR EXPORT", "SENASA al día", "Rational · Irinox"].map((tag) => (
                <span
                  key={tag}
                  className="text-xs text-neutral-300 px-2.5 py-1 rounded-full"
