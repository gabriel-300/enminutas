          ...
          <div className="p-10 lg:p-14 max-w-2xl">
            ...
            <div className="mt-8">
              <a
                ...
                aria-label="Consultar condiciones mayoristas por WhatsApp"
                className="inline-flex items-center gap-2.5 px-5 py-3 rounded-xl text-sm font-semibold text-white border-2 border-white/30 hover:bg-white/10 transition-colors"
              >
