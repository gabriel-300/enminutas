...
export function WhatsAppButton({ whatsapp = "5493765017944" }: Props) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 px-4 py-3 rounded-full text-white text-sm font-semibold shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl active:scale-95"
