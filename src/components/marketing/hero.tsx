      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center pb-16 lg:pb-20">
          ...
          <div>
            ...
            >
              Fábrica de ultracongelados para gastronomía y retail
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center size-12 rounded-xl text-white bg-brand hover:bg-brand-hover transition-colors"
              >
