...
const NAV_ITEMS = [
  ...
  { href: "/admin/produccion",     label: "Producción",    roles: ["admin", "produccion"] },
  { href: "/admin/cocina",         label: "Cocina / Stock",  roles: ["admin", "produccion"] },
  ...
  { href: "/admin/cocina/historial",     label: "Historial prod.",    roles: ["admin", "produccion"] },
  { href: "/admin/distribucion",   label: "Distribución",  roles: ["admin", "distribucion"] },
