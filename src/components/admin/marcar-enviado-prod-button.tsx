...
export function MarcarEnviadoProdButton({ orderId }: { orderId: string }) {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="w-full sm:w-auto px-4 py-2.5 rounded-lg border border-n-btn text-sm font-medium text-neutral-800 hover:bg-neutral-50 disabled:opacity-50 transition-colors"
    >
