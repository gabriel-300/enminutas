    ...
    <div className="space-y-4">
      ...
      {clientes.length > 0 && (
        <input
          ...
          className="w-full md:max-w-xs px-3 py-2 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-tierra-700/20"
        />
      )}
              ...
              <div key={c.id} className="bg-white rounded-2xl border border-neutral-200 p-4">
                ...
                {c.phone && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className="inline-flex items-center gap-1 text-xs font-medium !text-green-700 mb-2"
                  >
                ...
                {c.lastOrder && (
                  <div className="flex items-center gap-2 text-xs text-neutral-500 mb-2">
                    <span>Último:</span>
                    <Link href={`/admin/pedidos/${c.lastOrder.id}`} className="font-mono !text-neutral-500 hover:!text-tierra-700">
                ...
                <div className="flex gap-2">
                  ...
                  <Link
                    ...
                    className="flex-1 text-center py-2 text-xs font-medium rounded-xl bg-tierra-700 !text-white hover:bg-tierra-800 transition-colors"
                  >
                    + Nuevo pedido
                  </Link>
                </div>
